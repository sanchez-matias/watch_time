// Este MovieDetails sera util para mapear la respuesta que vendrá de la
// peticion que le hacemos al API cuando pedimos una movie por ID. Podemos verlo
// invocado en moviedb_datasource.dart
...
class MovieDetails {
  ...
  factory MovieDetails.fromMap(Map<String, dynamic> json) => MovieDetails(
        ...
        // Algunas peliculas como barbie (id: 346698) no tienen el BelongsToColection,
        // por lo que debemos tener eso en cuenta para poder tomar los parametros
